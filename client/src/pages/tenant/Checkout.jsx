...
export default function Checkout() {
    ...
    const [billingCycle, setBillingCycle] = useState(1); // 1 = Monthly, 2 = Yearly
    ...
    const price = billingCycle === 1 ? plan.monthlyPrice : plan.yearlyPrice;
                    ...
                    <div className="bg-white border-slate-200 border p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <div className="mb-4">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    {/* Monthly Option */}
                                    <label className={`border rounded p-3 cursor-pointer flex flex-col transition-all ${billingCycle === 1 ? 'border-[#091E42] bg-blue-50/30 ring-1 ring-[#091E42]' : 'border-slate-200 hover:border-slate-300'}`}>
                                    ...
                                    {/* Yearly Option */}
                                    <label className={`border rounded p-3 cursor-pointer flex flex-col transition-all ${billingCycle === 2 ? 'border-[#091E42] bg-blue-50/30 ring-1 ring-[#091E42]' : 'border-slate-200 hover:border-slate-300'}`}>
                        ...
                        <div className="space-y-2 text-xs">
                            <div className="flex justify-between text-slate-600">
                                <span>{billingCycle === 1 ? "Monthly" : "Yearly"} Amount</span>
